...
MIN_PHONE_DIGITS = 10
MAX_PHONE_DIGITS = 12
PHONE_PATTERN = re.compile(rf'^\+\d{{{MIN_PHONE_DIGITS},{MAX_PHONE_DIGITS}}}$')
...
MAX_LENGTH_USER_PHONE = MAX_PHONE_DIGITS + 1
...
PASSWORD_PATTERN = re.compile(rf'^[A-Za-z0-9{PASSWORD_ALLOWED_SYMBOLS}]+$')
...
MAX_LENGTH_CAFE_PHONE = MAX_PHONE_DIGITS + 1
