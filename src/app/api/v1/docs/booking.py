...
BOOKING_CONFIRM_STATUS_DESCRIPTION = (
    'Подтверждает бронирование, устанавливая статус "CONFIRMED". '
    'Доступно администатору и менеджеру кафе.'
)

BOOKING_CANCELLED_STATUS_DESCRIPTION = (
    'Отменяет бронирование, устанавливая статус "CANCELLED". '
    'Доступно автору бронирования, администатору и менеджеру кафе.'
)

BOOKING_COMPLETED_STATUS_DESCRIPTION = (
    'Отменяет бронирование, устанавливая статус "COMPLETED". '
    'Доступно администатору и менеджеру кафе.'
)

BOOKING_ACTIVATE_DESCRIPTION = (
    'Активирует бронирование путем установки атрибута `is_active=True`. '
    'Доступно администатору и менеджеру кафе.'
)
